...
class ListsSuite extends FunSuite {
  ...
  test("sum of a few numbers") {
   ...
   test("sum of mixed sign numbers") {
    assert(sum(List(1,-3, 5, -8, 2)) === -3)
  }
  ...
  test("maxOfTwo - right is max") {
    assert(maxOfTwo(3, 1) === 3)
  }

  test("maxOfTwo - left is max") {
    assert(maxOfTwo(3, 7) === 7)
  }
  
  test("maxOfTwo - left = right") {
    assert(maxOfTwo(2, 2) === 2)
  }
  ...
  test("max of some mixed sign numbers") {
    assert(max(List(3, -7, 2)) === 3)
  }
  
  test("max of list of all negative numbers") {
    assert(max(List(-2, -7, -3)) === -2)
  }
    
  test("max of list of a single number") {
    assert(max(List(5)) === 5)
  }
